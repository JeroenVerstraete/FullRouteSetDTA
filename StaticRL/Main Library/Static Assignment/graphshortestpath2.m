function [pred,dist] = graphshortestpath2(G,S,varargin)
...
%   $Revision: 1.1.6.10 $  $Date: 2010/12/22 16:19:46 $
...
%         error(message('bioinfo:graphshortestpath:IncorrectNumberOfArguments', mfilename));
    end
