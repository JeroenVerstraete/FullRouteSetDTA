...
static emlrtRSInfo ke_emlrtRSI = { 74, "eml_int_forloop_overflow_check",
  "C:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\eml_int_forloop_overflow_check.m"
};

static emlrtRSInfo ne_emlrtRSI = { 75, "eml_int_forloop_overflow_check",
  "C:\\Program Files\\MATLAB\\R2014a\\toolbox\\eml\\lib\\matlab\\eml\\eml_int_forloop_overflow_check.m"
};
  ...
  mxArray *c, emlrtMCInfo *location)
{
  ...
  pArrays[0] = b;
  pArrays[1] = c;
  return emlrtCallMATLABR2012b(sp, 1, &m17, 2, pArrays, "message", true,
    location);
}
...
void check_forloop_overflow_error(const emlrtStack *sp)
{
  ...
  b_st.tls = sp->tls;
  y = NULL;
  m1 = emlrtCreateCharArray(2, iv23);
  for (i = 0; i < 34; i++) {
    cv6[i] = cv7[i];
  }
  ...
  emlrtAssign(&y, m1);
  b_y = NULL;
  m1 = emlrtCreateCharArray(2, iv24);
  for (i = 0; i < 23; i++) {
    cv8[i] = cv9[i];
  }
