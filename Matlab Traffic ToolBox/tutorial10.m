...
%% Introduction
% In this tutorial a basic algorithm is implemented to find deterministic
% user equilibrium in a dynamic traffic assignment. The solution is found
% by means of the method of successive averages (MSA).
%
...
display('<<<Introducing deterministic equilibrium routing>>>')
...
title('Travel time alternative route','FontSize',14,'fontweight','b')
